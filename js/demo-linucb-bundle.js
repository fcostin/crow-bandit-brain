...
module.exports.swap = __webpack_require__(12);
module.exports.scal = __webpack_require__(13);
module.exports.copy = __webpack_require__(14);
module.exports.axpy = __webpack_require__(15);
module.exports.dot = __webpack_require__(16);
module.exports.cpsc = __webpack_require__(17);
module.exports.nrm2 = __webpack_require__(18);
module.exports.asum = __webpack_require__(19);
module.exports.iamax = __webpack_require__(20);
module.exports.rotg = __webpack_require__(21);
...
var blas = __webpack_require__(2);
var abs = Math.abs;
var sqrt = Math.sqrt;
var dot = blas.dot;
var axpy = blas.axpy;
...
var iota = __webpack_require__(22)
...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c14 = function(a, b, c) { return makeFloat(a, b, c); },
        peg$c15 = "~",
        peg$c16 = peg$literalExpectation("~", false),
        peg$c17 = function(variable_name, distribution) {
                return {
        ...
        peg$c22 = function(function_name, param_bindings) {
                return {
                    "func": function_name,
                    "args": param_bindings,
                }
        ...
        peg$c28 = function(param_name, param_value) {
                return {
                    "k":param_name,
                    "v":param_value,
                }
...
var blas1 = __webpack_require__(2)
...
// EXTERNAL MODULE: ./src/demo/linucb/scenario_parser.js
var scenario_parser = __webpack_require__(8);

// EXTERNAL MODULE: ./node_modules/ndarray-householder-qr/index.js
var ndarray_householder_qr = __webpack_require__(6);

// EXTERNAL MODULE: ./node_modules/ndarray/ndarray.js
var ndarray = __webpack_require__(7);

// EXTERNAL MODULE: ./node_modules/ndarray-ops/ndarray-ops.js
var ndarray_ops = __webpack_require__(9);

// EXTERNAL MODULE: ./node_modules/ndarray-blas-dger/lib/index.js
var lib = __webpack_require__(10);
var lib_default = /*#__PURE__*/__webpack_require__.n(lib);

// EXTERNAL MODULE: ./node_modules/ndarray-blas-level1/index.js
var ndarray_blas_level1 = __webpack_require__(2);

// CONCATENATED MODULE: ./src/demo/linucb/linucb.js
...
const qr_invert = function(A) {
    ...
    let QR = clone(A);
    let R_diag = zeros([d]);
    ndarray_householder_qr["factor"](QR, R_diag);
    const solve = function(y) {
        let x = clone(y);
        ndarray_householder_qr["solve"](QR, R_diag, x);
        return x;
    }
    return solve;
};
...
function NewLinUCB(alpha, d, actions) {
    const obj = {
        ...
        getUCB: function(model, x) {
            ...
            return Object(ndarray_blas_level1["dot"])(theta, x) + this.alpha * Math.sqrt(Object(ndarray_blas_level1["dot"])(x, inv_A(x)));
        },
        ...
        updateReward: function(x, a_star, r) {
            // A <- A + outer(x, x^T)
            lib_default()(1, x, x, this.A_by_a.get(a_star)); // BLAS Level 2 DGER

            // b <- b + r * x
            Object(ndarray_blas_level1["axpy"])(r, x, this.b_by_a.get(a_star));
        },
    };
    return obj;
};
...
// CONCATENATED MODULE: ./src/demo/linucb/index.js
    ...
    methods: {
        step: function(event) {
            if (this.sim == null) {
                ...
                try {
                    ctx.input_scenarios = Object(scenario_parser["parse"])(this.param_scenario_defns);
                } catch(e) {
